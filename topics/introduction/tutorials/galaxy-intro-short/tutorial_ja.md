...
> ### {% icon hands_on %} ハンズオン: Log in to Galaxy
...
> ### {% icon hands_on %} ハンズオン: Name history
> 1. Go to the **History** panel (on the right)
> 2. Click on the history name ("Unnamed history")
>
...
> ### {% icon hands_on %} ハンズオン: Upload a file from URL
...
> ### {% icon hands_on %} ハンズオン: View the file content
...
> ### {% icon hands_on %} ハンズオン: Use a tool
> 1. Type **FastQC** in the tools panel search box (top)
> 2. Click on the tool **FastQC** {% icon tool %}
>
...
>    - No change in the other paramters
> 4. Click **Execute**
>
{: .hands_on}
...
> ### {% icon hands_on %} ハンズオン: View results
...
> ### {% icon hands_on %} ハンズオン: Run another tool
...
> ### {% icon hands_on %} ハンズオン: Get metadata about a file
...
> ### {% icon hands_on %} ハンズオン: Re-run the tool
...
> ### {% icon hands_on %} ハンズオン: New history
...
> ### {% icon hands_on %} ハンズオン: View histories
